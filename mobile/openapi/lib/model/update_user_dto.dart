...
class UpdateUserDto {
  ...
  @override
  String toString() => 'UpdateUserDto[id=$id, isAdmin=$isAdmin, shouldChangePassword=$shouldChangePassword, username=$username, email=$email, password=$password, firstName=$firstName, lastName=$lastName]';
